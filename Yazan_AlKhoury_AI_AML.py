# -*- coding: utf-8 -*-
"""Yazan_Al_Khoury_AI FINAL_VERSION.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ztjVdb1Z2z_JmDE5esQTOYqmivON6Ppa
...
# Target Correlation: Top 15 Indicators
plt.figure(figsize=(15, 3))

all_corrs = df.corr()['status'].sort_values(ascending=False)
top_features = all_corrs.abs().sort_values(ascending=False).head(16).index
top_corrs = all_corrs[top_features].drop('status') # Remove the 1.0 correlation with itself

# 2. Transpose (.T) to make it horizontal
sns.heatmap(top_corrs.to_frame().T, annot=True, cmap='coolwarm', center=0, fmt='.2f', cbar=False)

plt.title('Top 15 Features Most Correlated with Phishing Status')
...
plt.title('Confusion Matrix for Test Data LR')
...
feature_names = X.columns # Ensure 'X' is your dataframe of features
...
plt.title('Top 10 Most Influential Features (Random Forest Logic)')
